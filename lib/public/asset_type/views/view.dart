...
class FormAssetTypeDropDown extends ConsumerStatefulWidget {
  const FormAssetTypeDropDown({super.key, this.selectedID, required this.onchanged});
  final String? selectedID;
  final Function(AssetTypeDropdownModel) onchanged;

  @override
  ConsumerState<FormAssetTypeDropDown> createState() => _ProjectTypeDropDownState();
}

class _ProjectTypeDropDownState extends ConsumerState<FormAssetTypeDropDown> {
  @override
  Widget build(BuildContext context) {
    AsyncValue<List<AssetTypeDropdownModel>> listData = ref.watch(assetTypeDropdownProvider);
    {
      return Padding(
  ...
  Widget _data(BuildContext context, List<AssetTypeDropdownModel> data) {
    String? initialText;
