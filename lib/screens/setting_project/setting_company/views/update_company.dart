...
class UpdateCompanyScreen extends BaseStatefulWidget {
  final String companyId;
  final String previousPageTitle;
  const UpdateCompanyScreen(this.previousPageTitle, this.companyId, {Key? key}) : super(key: key, subPage: true);
  @override
  _UpdateCompanyScreenState createState() => _UpdateCompanyScreenState();
}

class _UpdateCompanyScreenState extends BaseState<UpdateCompanyScreen> {
  ...
  int length = 1;
  final updateCompanyKey = GlobalKey<FormState>();
  @override
  void initState() {
  ...
  void submitCreateCompay() async {
    ...
    if (updateCompanyKey.currentState!.validate()) {
  ...
  Widget topbar() {
    return CupertinoSliverNavigationBar(
      ...
      trailing: Padding(
        ...
        child: ButtonCustom(
          key: ValueKey(updateCompanyKey.currentState != null && updateCompanyKey.currentState!.validate()),
          enabled: updateCompanyKey.currentState != null && updateCompanyKey.currentState!.validate(),
          buttonType: ButtonType.filled,
          text: Trans().textUpdate,
          loading: ref.watch(createCompanyProvider).isLoading,
          onTap: submitCreateCompay,
        ),
      ),
      largeTitle: Text(Trans().titleUpdateCompany),
    );
  }
